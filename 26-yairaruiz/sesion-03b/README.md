...
En esta clase avanzamos en el proyecto 01: 

En la clase anterior definimos utilizar el poema gansos salvajes de mary Oliver.

+ trabajamos en definir el diagrama de flujo para entender y ordenar mejor cómo funcionaría nuestro código y a la par avanzando con el código.
+ este día pudimos resolver el orden y las ideas del diagrama de flujo para empezar a solucionar y armar el código
...
+ char
+ es un tipo de dato que guarda un solo carácter
+ ejemplo: una letra, número o símbolo
+ si quiero guardar una palabra, necesito varios char

+ char[]
+ es un conjunto de caracteres que permite formar una palabra o frase
+ cada carácter ocupa una posición

+ String
+ sirve para trabajar con textos completos de una forma más sencilla
+ también permite juntar o modificar textos fácilmente
+ en Arduino se escribe con S mayúscula
  
No es un tipo básico de C++, sino una clase que facilita trabajar con texto

+ array
+ Es una estructura que permite guardar varios elementos juntos
+ Las posiciones comienzan desde 0
+ Puede contener números, caracteres, textos, etc.

+ Array de Strings
+ Permite guardar varios textos dentro de una misma estructura
+ Puede ser útil para nuestro proyecto porque podemos tener varias frases o palabras que después se muestran en la pantalla
