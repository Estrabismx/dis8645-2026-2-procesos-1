...
// potenciómetro 2 (elige poema1 / poemaLuz, y controla el LED)
...
// ================= animaciones: líneas disparadoras y tolerancia =================
...
// IMPORTANTE: como ahora el scroll de poemaLuz avanza de a 2 líneas, "lineaActualLuz"
// solo toma valores PARES (0, 2, 4, 6...) — por eso tolLinea NO puede ser 0, o los
// objetivos impares (7 y 17) nunca se alcanzarían exactamente.
...
// ================= layout de la pantalla (ventana visible, centrado) =================
...
// ================= setup: sucede una sola vez al encender =================
...
void setup() {
  ...
  // la librería SH110X no tiene "ssd1306_command()", pero sí tiene
...
// ================= loop: se repite todo el tiempo mientras el Arduino esté encendido =================
...
// todas las llamadas SSD1306_WHITE -> SH110X_WHITE

void mostrarAnimacion1() {
  static int radio = 0;
  static int direccion = 1;

  display.drawCircle(64, 32, radio, SH110X_WHITE);
...
void mostrarAnimacion2() {
  ...
  display.fillTriangle(x, 32, x + 12, 24, x + 12, 40, SH110X_WHITE);
...
void mostrarAnimacion3() {
  ...
  display.drawCircle(64, 32, radio % 30, SH110X_WHITE);
  display.drawCircle(64, 32, (radio + 10) % 30, SH110X_WHITE);
  display.drawCircle(64, 32, (radio + 20) % 30, SH110X_WHITE);
...
void mostrarAnimacion4() {
  ...
  display.fillCircle(64, y, 10, SH110X_WHITE);
