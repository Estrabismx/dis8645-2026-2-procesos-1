...
const int posicionAnimacionLlamas = 10;  // después del verso 8 (se corrió +1 por la nueva animación)
...
void loop() {
  ...
  if (posicionActual != posicionAnterior) {
    ...
    if (posicionActual == posicionAnimacionQueja) {
      ...
      // Calculamos cuántas animaciones ya "pasaron" antes de esta posición,
      // para saber cuánto restarle y obtener el índice real del verso
      ...
      Serial.println(misVersos[indiceActual]);
    }
